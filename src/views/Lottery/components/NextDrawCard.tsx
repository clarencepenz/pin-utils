...
const NextDrawCard = () => {
  ...
  return (
    <StyledCard>
      <CardHeader p="16px 24px" style={{ background: '#bb935c', borderBottom: '1px solid #fff' }}>
      ...
      <CardBody style={{ background: '#bb935c' }}>
        <Grid>
          ...
          <Flex flexDirection={['column', null, null, 'row']} alignItems={['center', null, null, 'center']}>
            ...
            <Flex justifyContent="center" w="100%">
              <BuyTicketsButton
                style={{ background: '#fff', color: '#bb935c', width: '213px', textTransform: 'uppercase' }}
      ...
      <CardFooter p="0" style={{ background: '#bb935c', borderTop: '1px solid #fff' }}>
        {isExpanded && (
          <NextDrawWrapper>
